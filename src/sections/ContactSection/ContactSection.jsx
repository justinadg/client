      ...
      <Grid container spacing={4}>
        ...
        <ContactInfoContainer item xs={12} md={6}>
          ...
          <Typography variant="subtitle1" color="textSecondary" gutterBottom>
            Located in Sumacab Esta Cabanatuan City, The Shop is easily
            ...
            makes it easy to drop by for a service.
          </Typography>
          ...
          <ContactInfoItem>
            ...
            <Typography variant="body1">contact@rasautocare.com</Typography>
          </ContactInfoItem>
